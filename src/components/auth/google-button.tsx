// "Continue with Google" button. The 4-colour G is Google's brand mark, kept as
// inline SVG (the standard approach for OAuth buttons). Wired to real OAuth in
// Phase 4; for now it is a presentational trigger.
